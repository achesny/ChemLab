...
public class ChemLab {
	...
	static Block atomSplitter;
	static Block atomFuser;
	...
	private void shapedRecipeRegisters() {
		...
		GameRegistry.addRecipe(
				new ItemStack(ChemLab.hydrogen, 1),
				new Object[] {"p  ","   ","e  ",
					'p',new ItemStack(ChemLab.proton,1),
					'e',new ItemStack(ChemLab.electron,1)
		});
		GameRegistry.addRecipe(
				new ItemStack(ChemLab.helium, 1), 
				new Object[] {"p  ","n  ","e  ", 
					'p', new ItemStack(ChemLab.proton, 2), 
					'n', new ItemStack(ChemLab.nuetron, 2),
					'e', new ItemStack(ChemLab.electron, 2)
		});
		GameRegistry.addRecipe(
				new ItemStack(ChemLab.nobelium, 1), 
				new Object[] {"pP ","nnN","e  ", 
					'p', new ItemStack(ChemLab.proton, 64), 
					'P', new ItemStack(ChemLab.proton, 38),
					'n', new ItemStack(ChemLab.nuetron, 64), 
					'N', new ItemStack(ChemLab.nuetron, 29), 
					'e', new ItemStack(ChemLab.electron, 60)
		});
	}
